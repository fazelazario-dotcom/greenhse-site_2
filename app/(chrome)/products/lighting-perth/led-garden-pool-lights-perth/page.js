...
/* ============================================================
   LANDSCAPE / GARDEN LIGHTING — category page
   URL: /products/lighting-perth/led-garden-pool-lights-perth/
   ...
   ============================================================ */
const KEY = '/products/lighting-perth/led-garden-pool-lights-perth/index.html';
const c = SITE.categories[KEY];

export const metadata = {
  title: c.title || c.h1,
  description: c.desc || undefined,
  alternates: { canonical: '/products/lighting-perth/led-garden-pool-lights-perth/' },
};
