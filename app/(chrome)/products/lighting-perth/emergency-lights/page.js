...
/* ============================================================
   EMERGENCY LIGHTS — category page
   URL: /products/lighting-perth/emergency-lights/
   ...
   ============================================================ */
const KEY = '/products/lighting-perth/emergency-lights/index.html';
const c = SITE.categories[KEY];

export const metadata = {
  title: c.title || c.h1,
  description: c.desc || undefined,
  alternates: { canonical: '/products/lighting-perth/emergency-lights/' },
};
