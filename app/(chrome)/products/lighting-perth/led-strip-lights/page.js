...
/* ============================================================
   STRIP LIGHTS PERTH — category page
   URL: /products/lighting-perth/led-strip-lights/
   Product groups on this page: Strips, by the metre, Power & control, Ready-made linear fittings.
   ...
   ============================================================ */
const KEY = '/products/lighting-perth/led-strip-lights/index.html';
const c = SITE.categories[KEY];

export const metadata = {
  title: c.title || c.h1,
  description: c.desc || undefined,
  alternates: { canonical: '/products/lighting-perth/led-strip-lights/' },
};
