...
/* ============================================================
   OUTDOOR / WALL LIGHTS — category page
   URL: /products/lighting-perth/led-outdoor-wall-lights-perth/
   Product groups on this page: Wall lights, Garden & in-ground, Floodlights & sensors, Canopy & area lights.
   ...
   ============================================================ */
const KEY = '/products/lighting-perth/led-outdoor-wall-lights-perth/index.html';
const c = SITE.categories[KEY];

export const metadata = {
  title: c.title || c.h1,
  description: c.desc || undefined,
  alternates: { canonical: '/products/lighting-perth/led-outdoor-wall-lights-perth/' },
};
