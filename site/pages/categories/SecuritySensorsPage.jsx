...
function G() {
  return (
    <section
      className={JSXStyle.dynamic([['bfafccc7d880c015', [asset.asset('/images/hero/security-hero.webp')]]]) + ' hero'}
    >
      <div
        aria-hidden="true"
        className={
          JSXStyle.dynamic([['bfafccc7d880c015', [asset.asset('/images/hero/security-hero.webp')]]]) + ' hero__scrim'
        }
      />
      <div
        className={
          JSXStyle.dynamic([['bfafccc7d880c015', [asset.asset('/images/hero/security-hero.webp')]]]) +
      ...
      >
        ...
        >
          {'Security & Sensors · Australian Certified · Perth, WA'}
        </span>
        <h1
          className={
            JSXStyle.dynamic([['bfafccc7d880c015', [asset.asset('/images/hero/security-hero.webp')]]]) + ' hero__title'
          }
        >
          Watching,
          <br className={JSXStyle.dynamic([['bfafccc7d880c015', [asset.asset('/images/hero/security-hero.webp')]]])} />
          <span
            className={
              JSXStyle.dynamic([['bfafccc7d880c015', [asset.asset('/images/hero/security-hero.webp')]]]) +
              ' hero__accent'
        ...
        <p
          className={
            JSXStyle.dynamic([['bfafccc7d880c015', [asset.asset('/images/hero/security-hero.webp')]]]) + ' hero__lead'
          }
        >
          Security cameras, motion sensors and alarm-ready fittings that keep watch around the clock — with night vision
          and motion detection built in, not bolted on.
        </p>
        <div
          className={
            JSXStyle.dynamic([['bfafccc7d880c015', [asset.asset('/images/hero/security-hero.webp')]]]) +
        ...
        >
          ...
          >
            {'Shop Security & Sensors '}
            <span
              aria-hidden="true"
              className={JSXStyle.dynamic([['bfafccc7d880c015', [asset.asset('/images/hero/security-hero.webp')]]])}
            >
              →
            </span>
          </a>
...
let h = [
    {
      Icon: Icons.IconEye,
      label: 'Night vision',
      text: 'Built-in infrared (IR) illuminators on cameras give usable night vision without a separate light.',
    },
    {
      Icon: Icons.IconSliders,
      label: 'Detection range',
      text: "Check a PIR sensor's range and angle against the actual area you want covered.",
    },
    {
      Icon: Icons.IconWifi,
      label: 'Wired or Wi-Fi',
      text: 'Wired is more reliable for a permanent install; Wi-Fi units are quicker to add or reposition.',
    },
  ],
  x = [
    {
      Icon: Icons.IconEye,
      title: 'Plan lighting and security together',
      text: "Cameras and motion sensors work best when they're planned alongside your lighting, not bolted on afterwards — a camera pointed into a floodlight undercuts what it's there for.",
    },
    {
      Icon: Icons.IconSliders,
      title: 'Coverage and detection range',
      text: 'Look for built-in infrared (IR) illuminators on cameras for usable night vision, and check detection range and angle on PIR sensors against the actual area you want covered.',
    },
    {
      Icon: Icons.IconWifi,
      title: 'Wired vs Wi-Fi',
      text: 'Wired is more reliable for a permanent install, while Wi-Fi units are quicker to add or reposition without running new cable.',
    },
  ];
export default function Default() {
  ...
  (React.useEffect(() => {
    ...
    React.useEffect(() => {
      ...
      return (
        (async () => {
          try {
            let a = await api.fetchCategory(api.SECURITY_CATEGORY_ID),
  ...
  return (
    <main className="jsx-3ac0f3074f9c414a home">
      <G />
      <section id="security" className="jsx-3ac0f3074f9c414a range">
        <div className="jsx-3ac0f3074f9c414a container">
          <div className="jsx-3ac0f3074f9c414a range__head">
            <div className="jsx-3ac0f3074f9c414a range__copy">
              <span className="jsx-3ac0f3074f9c414a eyebrow">{'Featured · Security & Sensors'}</span>
              <h1 className="jsx-3ac0f3074f9c414a range__title">Find your perfect security fitting</h1>
              <p className="jsx-3ac0f3074f9c414a range__sub">
                Browse the full security and sensor range below — Australian certified, Perth stock and support.
              </p>
            </div>
          </div>
          {!m && b && (
      ...
      <VideosSection />
      <GuideSection
        eyebrow="Security & Sensors · Buying Guide"
        title="Security Lighting and Sensors That Work Together"
        subtitle="Cameras, PIR sensors and floodlights planned as one system — not bolted on afterwards."
        stats={h}
        cards={x}
        CalloutIcon={Icons.IconPhone}
        calloutText={
          <>
            Planning a security or sensor upgrade? Call our Perth-based team on{' '}
