...
function H() {
  return (
    <section
      className={JSXStyle.dynamic([['23367a8a548fe55b', [asset.asset('/images/hero/switches-hero.webp')]]]) + ' hero'}
    >
      <div
        aria-hidden="true"
        className={
          JSXStyle.dynamic([['23367a8a548fe55b', [asset.asset('/images/hero/switches-hero.webp')]]]) + ' hero__scrim'
        }
      />
      <div
        className={
          JSXStyle.dynamic([['23367a8a548fe55b', [asset.asset('/images/hero/switches-hero.webp')]]]) +
      ...
      >
        ...
        >
          {'Switches & Powerpoints · Australian Certified · Perth, WA'}
        </span>
        <h1
          className={
            JSXStyle.dynamic([['23367a8a548fe55b', [asset.asset('/images/hero/switches-hero.webp')]]]) + ' hero__title'
          }
        >
          The details,
          <br className={JSXStyle.dynamic([['23367a8a548fe55b', [asset.asset('/images/hero/switches-hero.webp')]]])} />
          <span
            className={
              JSXStyle.dynamic([['23367a8a548fe55b', [asset.asset('/images/hero/switches-hero.webp')]]]) +
              ' hero__accent'
        ...
        <p
          className={
            JSXStyle.dynamic([['23367a8a548fe55b', [asset.asset('/images/hero/switches-hero.webp')]]]) + ' hero__lead'
          }
        >
          Glass touch switches and powerpoints (including USB-integrated options) that finish a room properly — the
          fittings you touch every day, built to feel like it.
        </p>
        <div
          className={
            JSXStyle.dynamic([['23367a8a548fe55b', [asset.asset('/images/hero/switches-hero.webp')]]]) +
        ...
        >
          ...
          >
            {'Shop Switches & Powerpoints '}
            <span
              aria-hidden="true"
              className={JSXStyle.dynamic([['23367a8a548fe55b', [asset.asset('/images/hero/switches-hero.webp')]]])}
            >
              →
            </span>
          </a>
...
let g = [
    {
      ...
      label: 'Glass finish',
      text: 'A clean, seamless face plate with no visible screws.',
    },
    {
      Icon: Icons.IconSparkle,
      label: 'Locator light',
      text: 'A low-glow indicator makes the switch easy to find in the dark.',
    },
    {
      Icon: Icons.IconBolt,
      label: 'USB charging',
      text: 'USB-A and/or USB-C ports built into the powerpoint, alongside the standard outlets.',
    },
  ],
  x = [
    {
      Icon: Icons.IconLayout,
      title: 'Glass switch panels',
      text: 'Glass switch panels give a clean, seamless face plate with no visible screws, and usually include a low-glow locator light so the switch is easy to find in the dark.',
    },
    {
      Icon: Icons.IconSparkle,
      title: 'Finished, not just functional',
      text: 'Switches and powerpoints are the fittings a room touches every single day — small details like a glass finish or a soft-touch action are what make a fit-out feel finished.',
    },
    {
      Icon: Icons.IconBolt,
      title: 'USB-integrated powerpoints',
      text: 'USB-integrated powerpoints add USB-A and/or USB-C charging ports alongside the standard outlets — handy next to a bed, desk or kitchen bench.',
    },
  ];
export default function Default() {
  let [e, f] = React.useState([]),
    ...
    [j, w] = React.useState([]),
    [y, v] = React.useState(!0);
  (React.useEffect(() => {
    let e = !1;
    return (
      api
        .fetchStripLightProducts({
          id: api.SWITCHES_CATEGORY_ID,
    ...
    React.useEffect(() => {
      ...
      return (
        (async () => {
          try {
            let a = await api.fetchCategory(api.SWITCHES_CATEGORY_ID),
      ...
      return [
        ...
        ...(a.length
          ? [
              {
                id: 'more',
                label: 'More switches & powerpoints',
                products: a,
              },
            ]
          : []),
  ...
  return (
    <main className="jsx-3ac0f3074f9c414a home">
      <H />
      <section id="switches" className="jsx-3ac0f3074f9c414a range">
        <div className="jsx-3ac0f3074f9c414a container">
          <div className="jsx-3ac0f3074f9c414a range__head">
            <div className="jsx-3ac0f3074f9c414a range__copy">
              <span className="jsx-3ac0f3074f9c414a eyebrow">{'Featured · Switches & Powerpoints'}</span>
              <h1 className="jsx-3ac0f3074f9c414a range__title">Find your perfect switch or powerpoint</h1>
              <p className="jsx-3ac0f3074f9c414a range__sub">
                Browse the full switch and powerpoint range below — Australian certified, Perth stock and support.
              </p>
            </div>
          </div>
          {!m && b && (
      ...
      <VideosSection />
      <GuideSection
        eyebrow="Switches & Powerpoints · Buying Guide"
        title="Switches and Powerpoints That Finish a Fit-Out"
        subtitle="Glass panels, locator lights and USB-integrated powerpoints — the everyday details that make a room feel finished."
        stats={g}
        cards={x}
        CalloutIcon={Icons.IconPhone}
        calloutText={
          <>
            All switches and powerpoints must be installed by a licensed electrician. Want help choosing a finish or
            layout? Call our Perth-based team on{' '}
